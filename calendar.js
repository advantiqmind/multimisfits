...
.cal-grid{display:grid;grid-template-columns:repeat(7,1fr);padding:0 16px 16px;gap:1px;overflow:hidden}
...
.cal-cell{height:90px;background:#110e07;border:1px solid #2a2010;padding:4px;position:relative;transition:background .15s;overflow:hidden;box-sizing:border-box}
